...
if ($status === false) {
    ...
    while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {  
        ...
        $time_weekday .= '睡眠時間（平日）： ' .  $result['time_weekday']. ' 時間';
        $time_weekend .= '睡眠時間（週末）： ' .  $result['time_weekend']. ' 時間';    
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <a href="profile_detail01.php?id=<?= $id ?>" class="stretched-link">Continue reading</a>
        </div>
