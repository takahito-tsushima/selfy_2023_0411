...
<form method="POST" action="update00_photo01.php" id="photo" name="photo" enctype="multipart/form-data">

  <div class="px-4 py-5 my-5 text-center">
  <p class="photo_on"><?= $photo_on ?></p>
    <h1 class="display-5 fw-bold text-body-emphasis">ON / オンの写真</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">アップロードする画像ファイルを選択してください</p>
      <div class="my-5"><input type="file" name="photo_on" id="photo_on" accept="image/*" size="35"></div>
